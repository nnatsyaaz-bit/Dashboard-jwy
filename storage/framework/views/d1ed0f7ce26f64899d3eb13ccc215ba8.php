...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <p class="mb-1">
        <a href="<?php echo e(route('auth.register')); ?>">Belum punya akun? Daftar di sini</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
...
<?php /**PATH C:\tugas prak.2026 sem2\prak.pemrogramanweb\DASHBOARD.JUWITA\resources\views/auth/login.blade.php ENDPATH**/ ?>