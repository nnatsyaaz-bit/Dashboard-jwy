                ...
                <div class="card-body">
                    <div class="tab-content" id="custom-tabs-two-tabContent">
                        ...
                        <div class="tab-pane fade" id="edit" role="tabpanel">
                            <form action="<?php echo e(route('profiles.update', $profil->id ?? 1)); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\tugas prak.2026 sem2\prak.pemrogramanweb\materiday8\my_portofolio-main\resources\views/dashboard/view.blade.php ENDPATH**/ ?>