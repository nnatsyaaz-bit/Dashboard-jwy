    ...
    <div class="card-body">
      ...
      <form action="<?php echo e(route('register')); ?>" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" name="nama" class="form-control" placeholder="Nama Lengkap" value="<?php echo e(old('nama')); ?>">
      ...
      <p class="mt-3 mb-1">
        <a href="<?php echo e(route('auth.login')); ?>">Sudah punya akun? Login di sini</a>
      </p>
    </div>
  </div>
</div>
...
<?php /**PATH D:\Jwy.projectUas\my_portofolio-main\resources\views/auth/register.blade.php ENDPATH**/ ?>