<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
            ...
            <div class="info">
                <a href="<?php echo e(route('profil')); ?>" class="d-block font-weight-bold">Mahasiswa TRPL</a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('profile')); ?>" class="nav-link <?php echo e(Request::is('profiles*') ? 'active' : ''); ?>">
                ...
                <li class="nav-item mt-3">
                    <a href="<?php echo e(route('auth.logout')); ?>" class="nav-link text-danger">
...
<?php /**PATH C:\tugas prak.2026 sem2\prak.pemrogramanweb\materiday8\my_portofolio-main\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>